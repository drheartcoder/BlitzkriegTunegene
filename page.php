    	...
    	<div class="container">
          ...
          ================================================= -->
			...
			<?php 
				...
				$sql = mysql_query("SELECT * FROM pages WHERE member_id=$member_id");
              ...
              <div class="nearby-user">
                <div class="row">
                  ...
                  <div class="col-md-10 col-sm-10">
                    <h5><a href="pagefeeds.php?pages_id=<?php echo $res['pages_id'];?>" class="profile-link"><?php echo $res['page_name']; ?></a></h5>
                    <p><?php echo $res['about_page']; ?></p>
                  </div>
                </div>
              </div>
			<?php 
