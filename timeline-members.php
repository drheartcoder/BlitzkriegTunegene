        ...
        <div id="page-contents">
          <div class="row">
            ...
            <div class="col-md-7">
              ...
              <!-- Post Create Box
              ================================================= -->
              <?php include('post_create_member_timeline.php'); ?>
			...
			?>
              <div class="post-content">
                ...
                <div class="post-date hidden-xs hidden-sm">
                  <h5><?php if($row['timeline_post'] == 1){ echo user_member_id("member_name",$row['friend_id']); }else{ echo user_member_id("member_name",$row['member_id']); } ?></h5>
                  <p class="text-grey">
				<?php 
					$t1 = $row['entry_date'];
					$t2 = date('Y-m-d h:i:s');
				...
				<?php if($file_ext == "mp3" || $file_ext == "Ogg" || $file_ext == "wav"){?>
					<audio class="post-video" controls> <source src="<?php echo $row['post_media']; ?>" type="audio/<?php echo $file_ext; ?>"> </audio><?php }else{?>
					<video class="post-video" controls> <source src="<?php echo $row['post_media']; ?>" type="video/<?php echo $file_ext; ?>"> </video>
				<?php } }?>	
				
				
                <div class="post-container">
                  <img src="<?php if($row['timeline_post'] == 1){ 
						...
						if(user_member_id("profile_image",$_REQUEST['member_id']) !=""){ echo user_member_id("profile_image",$_REQUEST['member_id']); }else{ echo "http://placehold.it/300x300"; } 
					}  
				?>" alt="user" class="profile-photo-md pull-left" />
                  <div class="post-detail">
                    <div class="user-info">
                      <h5><a href="<?php if($row['timeline_post'] == 1){ ?> timeline-members.php?member_id=<?php echo $row['member_id']; ?> <?php }else{ echo "timeline.php"; }  ?>" class="profile-link"><?php if($row['timeline_post'] == 1){ echo user_member_id("member_name",$row['friend_id']); }else{ echo user_member_id("member_name",$row['member_id']); } ?></a> <span class="following">following</span></h5>
                      <p class="text-muted">
				<?php 
					$t1 = $row['entry_date'];
					$t2 = date('Y-m-d h:i:s');
