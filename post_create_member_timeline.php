			...
			<?php 
				if(isset($_POST['post'])){
					try{
						...
						$friend_id = $_SESSION['email_id']['member_id'];
...
if(in_array($file_ext,$expensions)=== true){	
	$sql="INSERT INTO post(member_id,post_content,post_images,entry_date,timeline_post,friend_id,ip) VALUES('$member_id','$texts','$file_name','$entry_date','1','$friend_id','$ipaddress')";
	$dbh->exec($sql);
	$token="postsuccess";
}else{
...
if(in_array($file_ext,$expensions)=== true){
	$sql="INSERT INTO post(member_id,post_content,post_media,entry_date,timeline_post,friend_id,ip) VALUES('$member_id','$texts','$file_name','$entry_date','1','$friend_id','$ipaddress')";
	$dbh->exec($sql);
	$token="postsuccess";
}else{
	...
	echo $sql="INSERT INTO post(member_id,post_content,entry_date,timeline_post,friend_id,ip) VALUES('$member_id','$texts','$entry_date','1','$friend_id','$ipaddress')";
	$dbh->exec($sql);
	$token="postsuccess";	
}	
