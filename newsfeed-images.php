    	...
    	<div class="container">
          ...
          ================================================= -->
			...
			<?php 
				...
				$sql="SELECT * from post where post_images !='' AND member_id IN (".$in_member.")  ORDER BY post_id desc";
				$sth = $dbh->query($sql);
				$i=0;
			...
			?>
                ...
                <div class="grid-item col-md-6 col-sm-6">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-<?php echo $i; ?>">
                      <img src="<?php echo $row['post_images']; ?>" alt="" class="img-responsive post-image" />
                    </div>
